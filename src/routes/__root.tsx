  ...
  head: () => ({
    meta: [
      ...
      { title: "Maison Lumière — Aesthetic & Skin Clinic, London" },
      {
        name: "description",
        content:
          "Maison Lumière is a London med spa offering microneedling, HydraFacial, anti-wrinkle injections, dermal fillers and more. Book your appointment today.",
      },
      ...
      { property: "og:title", content: "Maison Lumière — Aesthetic & Skin Clinic, London" },
      {
        ...
        content:
          "A London med spa devoted to subtle enhancement and lasting skin health. Book your treatment today.",
      },
